...
import {getMatches} from "../api/profilo";
                    ...
                    return (
                        <Card sx={{mx: 2, my: 1, backgroundColor: isMine ? 'white' : 'primary.light', color: isMine ? 'inherit' : 'primary.contrastText'}}>
                            <CardHeader
                                ...
                                avatar={<Avatar sx={{height: 24, width: 24}} src={currentPerson?.avatarPath ?? placeholder} />}
                                subheader={message?.sentAt.split('T')[0] + ' ' + message?.sentAt.split('T')[1].split('.')[0]}
